...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Update Pateint Details - DESIGN AND DEVELOPMENT OF A WEB BASED HOSPITAL MANAGEMENT SYSTEM FOR ARTHUR JARVIS UNIVERSITY</title>
          ...
          <form method="post">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                class="form-control form-control-sm rounded-0" value="<?php echo $row['cnic'];?>"  readonly/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">

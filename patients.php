...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Patients -DESIGN AND DEVELOPMENT OF A WEB BASED HOSPITAL MANAGEMENT SYSTEM FOR ARTHUR JARVIS UNIVERSITY </title>
        ...
        <div class="card-body">
          <form method="post">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                <label>Card No</label>
                <input type="text" id="cnic" name="cnic" required="required" readonly
                class="form-control form-control-sm rounded-0" value="<?php   echo $cnic; ?>"/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">

...
$message = '';
    ...
    $query = "select `id`, `display_name`, `user_name`, `profile_picture` from `users` where `user_name` = '$userName' and `password` = '$password';";
    try {
...
<head>
  ...
  <title>Login -DESIGN AND DEVELOPMENT OF A WEB BASED HOSPITAL MANAGEMENT SYSTEM FOR ARTHUR JARVIS UNIVERSITY </title>
...
<div class="login-box">
  <div class="login-logo mb-4">
    ...
    <div class="text-center h6 mb-0">DESIGN AND DEVELOPMENT OF A WEB BASED HOSPITAL MANAGEMENT SYSTEM FOR ARTHUR JARVIS UNIVERSITY </div>
  </div>
  <!-- /.login-logo -->
